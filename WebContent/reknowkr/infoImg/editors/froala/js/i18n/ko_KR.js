...
(function (global, factory) {
  ...
  FE.LANGUAGE['ko_KR'] = {
    translation: {
      ...
      "The pasted content is coming from a Microsoft Word document. Do you want to keep the format or clean it up?": "붙여넣은 문서는 Microsoft Word에서 가져왔습니다. 형식을 유지하거나 초기화 하시겠습니까?",
      "Keep": "유지하기",
      "Clean": "초기화",
      "Word Paste Detected": "Microsoft Word 형식 유지",
      "Characters": "문자",
      "More Text": "글꼴 더보기",
      ...
      "Double": "2.0",
      "Insert Files": "파일 삽입",
      "ImageTUI plugin is not enabled. Do you want to enable?": "ImageTUI 플러그인이 비활성화 되어 있습니다. 활성화 하시겠습니까?",
      "Enable": "활성화",
      "Upload Files": "파일 업로드",
      "Minimize": "최소화",
      "Dashed Borders": "점선",
