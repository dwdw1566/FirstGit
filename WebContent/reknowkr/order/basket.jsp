...
<!-- 장바구니 모듈Package -->
<div class="xans-element- xans-order xans-order-basketpackage "><!-- 장바구니 비어있을 때 -->
<div class="xans-element- xans-order xans-order-empty "><p>empty.</p>
</div>
<!-- 일반상품 START -->
<div class="orderList">
...
<p class="btnRight">
		...
		<a href="#none" onclick="Basket.orderAll(this)" class="" title="전체상품 주문" link-order="/order/orderform.html?basket_type=all_buy" link-login="../member/login.html">BUY ALL</a>
	</p>
<!-- 네이버 체크아웃 구매 버튼  -->
