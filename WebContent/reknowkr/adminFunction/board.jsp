...
<!-- Mirrored from reknow.kr/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Mar 2021 00:44:45 GMT -->
<!-- Added by HTTrack -->
		...
		a.onload = function() {
			i[r]
					.init(
							...
							{
								"token" : "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..65erQDLdWGJTTHvswQfBUJpgDYS7M4F7u6bpWejRHDg",
...
<link rel="canonical" href="main.rn" />
<link rel="alternate" href="http://m.reknow.kr/" />
<meta property="og:url" content="http://reknow.kr/" />
...
<body>
		...
		<div id="container">
			<div id="left">
				...
				<div id="category" style="margin-top: 125px"
					...
					<div class="position">
						<ul>
							<li class="xans-record-"><a href="product.ad">상품관리</a></li>
							<li class="xans-record-"><a href="member.ad">회원관리</a></li>

							<li class="xans-record-"><a href="board.ad">공지등록</a></li>
							<li class="xans-record-"><a href="qna.ad">Q&A게시판 관리</a></li>
							<li class="xans-record-"><a href="order.ad">주문관리</a></li>
							<li class="xans-record-"><a href="sales.ad">매출관리</a></li>
			...
			<div id="right">
				<a href="cart.in" class="top6">ADMIN</a>
			</div>
			<div id="contents">
				<div id="contents">
					<div
						...
						<div
							class="xans-element- xans-board xans-board-empty-4 xans-board-empty xans-board-4 boardListEmpty  ">
						</div>
						<div
							class="xans-element- xans-board xans-board-buttonlist-4 xans-board-buttonlist xans-board-4 displaynone ">
							<a href="write1da0.html?board_no=1" class="displaynone"><span
								class="sherbetbt_t white">WRITE</span></a>
						</div>
					</div>
					<hr>
					<form id="boardSearchForm" name=""
						action="http://reknow.kr/board/product/list.html" method="get"
							...
							<fieldset class="boardSearch">
								...
								<p>
									<select id="search_date" name="search_date" fw-filter=""
										...
										onclick="BOARD.form_submit('boardSearchForm');"><span
										class="sherbetbt_b white">찾기</span></a>
								</p>
	...
	<script type="text/javascript">
		...
		var mobileWeb = false;
		var aPopupListData = {
			"aPopupList" : "[{\"type\":\"L\",\"child_type\":\"W\",\"idx\":30,\"file\":\"\\\/popup\\\/popup_30.html\",\"size\":\"1000*1550\",\"position\":\"50*50\",\"title\":\"\\uc138\\uc77c\",\"open\":false}]",
			"aPopupCouponList" : [],
			"sIsAuthGuidePopup" : "",
			"sIsUpdateEventGuidePopup" : "",
			"sIsLifetimeEventGuidePopup" : "",
			"sPopupPage" : "F"
		};
		var aLogData = {
